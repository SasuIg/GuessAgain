document.addEventListener('DOMContentLoaded', function () {
    ...
    function restartGame() {
      ...
      inputBoxes.forEach(inputBox => inputBox.value = ''); // Clear input boxes on restart
      showSection('welcome');
    }
    ...
    Guess1btn.addEventListener('click', () => {
      ...
      if (guess1 === correctAnswer) {
        document.getElementById('guess4display').textContent = guess1;
        showSection('right');
      } else {
        ...
        if (guess2 === correctAnswer) { 
            document.getElementById('guess4display').textContent = guess2; 
            showSection('right'); 
        } else {
    ...
    Guess3btn.addEventListener('click', () => { 
        ...
        if (guess3 === correctAnswer) { 
            document.getElementById('guess4display').textContent = guess3; 
            showSection('right'); 
        } else {
